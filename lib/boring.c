/* BoringSSL compatability module */
#include <string.h>
...
static const EVP_CIPHER chacha20 = {
    ...
    .key_len            = CHACHA_KEY_SIZE,        /* key_len */
    .iv_len             = CHACHA_CTR_SIZE,        /* iv_len, 128-bit counter in the context */
    .ctx_size           = sizeof(EVP_CIPHER_CTX),
    .flags              = EVP_CIPH_CUSTOM_IV | EVP_CIPH_ALWAYS_CALL_INIT,
    .app_data           = NULL,
    .init               = chacha_init_key,
...
static /*int*/void chacha20_poly1305_cleanup(EVP_CIPHER_CTX *ctx)
{
    EVP_CHACHA_AEAD_CTX *actx = aead_data(ctx);
    if (actx)
...
static EVP_CIPHER chacha20_poly1305 = {
    ...
    .block_size         = 1,                  /* block_size */
    .key_len            = CHACHA_KEY_SIZE,    /* key_len */
    .iv_len             = 12,                 /* iv_len, 96-bit nonce in the context */
